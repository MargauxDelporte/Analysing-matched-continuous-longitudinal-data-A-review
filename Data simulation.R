...
library(mvtnorm)
library(xlsx)
setwd('C:/Users/u0118563/OneDrive - KU Leuven/Projecten/Gepaarde data/Submission 2/Data')
...
for(i in 0:99){
  ...
  data_cases_t2=treat_bl+control_bl+effect_pair+effects_subject[1:n_pairs,1]+(effects_subject[1:n_pairs,2]+treat_sl+control_sl)*1+rnorm(n=n_pairs,sd=1)
  data_cases_t3=treat_bl+control_bl+effect_pair+effects_subject[1:n_pairs,1]+(effects_subject[1:n_pairs,2]+treat_sl+control_sl)*2+rnorm(n=n_pairs,sd=1)
  data_cases_t4=treat_bl+control_bl+effect_pair+effects_subject[1:n_pairs,1]+(effects_subject[1:n_pairs,2]+treat_sl+control_sl)*3+rnorm(n=n_pairs,sd=1)
  data_cases_t5=treat_bl+control_bl+effect_pair+effects_subject[1:n_pairs,1]+(effects_subject[1:n_pairs,2]+treat_sl+control_sl)*4+rnorm(n=n_pairs,sd=1)
  ...
  data_controls_t2=control_bl+effect_pair+effects_subject[(n_pairs+1):(n_pairs*2),1]+(control_sl+effects_subject[(n_pairs+1):(n_pairs*2),2])*1+rnorm(n=n_pairs,sd=1)
  data_controls_t3=control_bl+effect_pair+effects_subject[(n_pairs+1):(n_pairs*2),1]+(control_sl+effects_subject[(n_pairs+1):(n_pairs*2),2])*2+rnorm(n=n_pairs,sd=1)
  data_controls_t4=control_bl+effect_pair+effects_subject[(n_pairs+1):(n_pairs*2),1]+(control_sl+effects_subject[(n_pairs+1):(n_pairs*2),2])*3+rnorm(n=n_pairs,sd=1)
  data_controls_t5=control_bl+effect_pair+effects_subject[(n_pairs+1):(n_pairs*2),1]+(control_sl+effects_subject[(n_pairs+1):(n_pairs*2),2])*4+rnorm(n=n_pairs,sd=1)
