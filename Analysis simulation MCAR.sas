...
t=time2;
run;
proc surveyselect data=&filename
	method=srs n=1600
	seed=123  
	out=&filename._mcar_l;
run;
...
run;
/*Delete 20% of the data at random*/
...
libname Rlmm 'C:\Users\u0118563\OneDrive - KU Leuven\Projecten\Gepaarde data\Submission 2\results by ana\Robust lmm\mcar';
...
libname mlmm 'C:\Users\u0118563\OneDrive - KU Leuven\Projecten\Gepaarde data\Submission 2\results by ana\marg lmm\mcar';
%macro marg(filename);
proc mixed data=work.&filename._mcar_l;
class pair id t;
model response=time2 treated time2*treated/solution ;
...
libname a 'C:\Users\u0118563\OneDrive - KU Leuven\Projecten\Gepaarde data\Submission 2\results by ana\autocorr\mcar';
...
libname clmm 'C:\Users\u0118563\OneDrive - KU Leuven\Projecten\Gepaarde data\Submission 2\results by ana\cond lmm\mcar';
